...
async def evaluate_timeslot(transmission_state):
    while True:
        ...
        await asyncio.sleep(transmission_state.next_transmission_microseconds)
...
async def main():
    ...
    while True:
        ...
        tornado_task = rainbow_cycle(pixels_DIO_Tornado,tornado_pixels,0)#color_cycle(transmission_state)
        ...
        await asyncio.gather(tornado_task, sao_h_task,sao_45_task,button_task,timeslot_task,recieve_task)#,blink_task)#,recieve_task,timeslot_task,transmission_task)
