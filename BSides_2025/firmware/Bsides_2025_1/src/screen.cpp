...
const unsigned char hashes[][32] = {
  ...
  {0xe, 0x26, 0xa2, 0xf7, 0x73, 0x54, 0xd0, 0x1b, 0x71, 0xb1, 0x60, 0xa, 0x82, 0xd9, 0xe9, 0xd1, 0xc1, 0xd9, 0x1f, 0xc3, 0x55, 0x2f, 0xd0, 0x13, 0x8d, 0x89, 0x9c, 0xae, 0x5e, 0xeb, 0xcc, 0xb3, },
...
void GameScreen::execute()
{
  ...
  if (buttonState.clicked)
  {
    ...
    if(q >= 0) {
      ...
      if (completedHashFlag == 0b0000111111111111) {
        setLitValue(0xFFF);
        delay(300);
        setLitValue(0);
        delay(300);
